...
--
-- Host: localhost    Database: sultana
-- ------------------------------------------------------
...
CREATE TABLE `passangers` (
  `passanger_id` int(100) NOT NULL AUTO_INCREMENT,
  `Passanger_name` varchar(100) DEFAULT NULL,
  `Location_Pickup` varchar(100) DEFAULT NULL,
  `Location_Where_To` varchar(100) DEFAULT NULL,
  `Cellphone` varchar(100) DEFAULT NULL,
  `Date_of_travel` varchar(45) DEFAULT NULL,
  `Number_of_Passangers` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2020-02-17 11:03:18
